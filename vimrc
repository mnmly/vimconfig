...
function! AppleConfig() 
  autocmd FileType javascript set shiftwidth=4|set tabstop=4|set noexpandtab|set softtabstop=0
  autocmd FileType scss set shiftwidth=4|set tabstop=4|set noexpandtab|set softtabstop=0
  autocmd FileType css set shiftwidth=4|set tabstop=4|set noexpandtab|set softtabstop=0
